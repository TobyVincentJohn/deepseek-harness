...
A compaction capability family (see [capability seams](../../.agents/notes/implemented/architecture/2026-06-13-capability-seams.md)): a Service Definition, a summarizing provider, a model-free tool-interaction pruning companion, and a human command Consumer. All **product** packages.
...
| [`compaction-tool-result-pruner/`](compaction-tool-result-pruner/README.md) | Optional model-free tool-input/result pruning | `ctx.toolResultPruner` |
