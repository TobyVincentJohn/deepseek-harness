...
flowchart TD
  ...
  subgraph group_builder["packages/builder"]
    pkg_tool_builder["tool-builder"]
  end
  ...
  pkg_tool_builder --> pkg_fs
  pkg_tool_builder --> pkg_invariants
  pkg_tool_builder --> pkg_system_prompt
  pkg_tool_builder --> pkg_tools
...
| [`tool-builder`](../packages/builder/tool-builder) | `builder` | [`fs`](../packages/fs/fs), [`invariants`](../packages/runtime-diagnostics/invariants), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
